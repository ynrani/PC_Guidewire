...
<title>TDM Portal | Data Subsetting</title>
...
<body>
	<div class="wrapper mainAll">
		...
		<div class="container">
			<form:form id="dataSubsettingForm" name="dataSubsettingForm"
				action="${pageContext.request.contextPath}/tdmDataSubsetting"
				modelAttribute="tdgDataSubsettingDTO">
				<ol class="breadcrumb">
				...
				<h2 style="color: #0098cc">
					<spring:message code="label.dtsub.dtl" />
				</h2>
				<hr>
				<div class="two-col">
					<table
						...
						<tbody>
							<tr>
								<td class="lable-title" width="80%" align="left" valign="middle"><spring:message
										code="label.dtsub.q1" /></td>
							</tr>
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.dtsub.q11" /><span>*</span></td>
								<td class="flied-title" width="20%" align="left" valign="middle">
									<form:textarea path="pageDtSub1" id="pageDtSub1"
										class="form-control" />
								</td>
							</tr>
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.dtsub.q2" /><span>*</span></td>
								<td class="lable-title" align="left" valign="middle" scope="col">
									<form:textarea path="pageDtSub2" id="pageDtSub2"
										class="form-control" />
								</td>
							</tr>
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.dtsub.q3" /> <span>*</span></td>
								<td class="flied-title" align="left" valign="middle"><form:textarea
										path="pageDtSub3" id="pageDtSub3" class="form-control" /></td>
							</tr>
						</tbody>
					</table>
					<br />
