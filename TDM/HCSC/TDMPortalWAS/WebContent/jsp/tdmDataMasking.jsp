...
<title>TDM Portal | Data Masking</title>
...
<body>
	<div class="mainAll">
		...
		<div class="container">
			...
			<form:form id="dataMaskingForm" name="dataMaskingForm"
				action="${pageContext.request.contextPath}/tdmDataMasking"
		...
		<li><a class="hrefVisited" href="./tdmDtMaskDashboard">Data Masking Dashboard</a></li> -->
				...
				<h2 style="color: #0098cc; font-size: 14px;">
					<spring:message code="label.dm.reqDtl" />
				</h2>
				<hr>
				...
				<div class="two-col">
					<table
						...
						<tbody>
							...
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.dm.projName" /><span>*</span></td>
								<td class="flied-title" align="left" valign="middle"><form:select
										path="projName" id="projName" class="down-control">
										<form:option value="">--Select--</form:option>
								...
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.dm.projPhase" /></td>
								<td class="flied-title" align="left" valign="middle"><form:select
										path="projPhase" id="projPhase" class="down-control">
										<form:option value="">--Select--</form:option>
							...
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.dm.projId" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="projectId" id="projectId" class="form-control" /></td>
								<td class="lable-title" align="left" valign="middle"><spring:message
					...
					<c:choose>
						...
						<c:otherwise>
							<table style="width: 100%; border: 0">
								<tbody>
									<tr>
										<th scope="col"><input type="button" id="continue"
...
$(document).ready(function() {
    ...
    $("#continue").click(function(){
           	document.location.href="./getDataMaskRequestDtlsForPage2";    	    		
  	  }); 
    
    $("#SaveAndContinue").click(function(){
       	document.location.href="./getDataMaskRequestDtlsForPage2?edit=true";    	    		
	 });    
  });	
});
</script>
