...
<body>
	<form:form
		action="${pageContext.request.contextPath}/loginforgotPassword"
		modelAttribute="forgotPasswordDto">
		<div align="center"
			style="text-align: center; padding: 10%; width: 50%;">
						...
						<table style="width: 50%" border="0">
							<tr>
								<td><form:input path="userId" id="userId"
										class="formcontrolForgot" placeholder="User ID"
										required="true" /></td>
							</tr>
							<tr>
								<td><form:input path="emailId" id="emailId"
										class="formcontrolForgot" placeholder="Email ID"
										required="true" /></td>
							</tr>
							<tr>
								<td align="center"><input type="button" name="submit"
									value="Send Email" class="btn-primary btn-cell"
