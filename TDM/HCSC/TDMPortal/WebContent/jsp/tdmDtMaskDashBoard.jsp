	...
	<div class="wrapper mainAll">
		...
		<div class="container">
	      ...
	      <h2 style="color: #0098cc"><spring:message code="label.dm.dashboard"/></h2> -->
			...
			<form:form id="tdmMaskingFRDataForm" name="tdmMaskingFRDataForm"
				action="${pageContext.request.contextPath}/tdmMaskingFR">
				<c:choose>
     		...
     		<a class="Button" href="${pageContext.request.servletContext.contextPath}/tdmDataMasking"><spring:message code="label.createNewReq"/></a>
					...
					<c:otherwise>
						<h3
							...
							<div>No data masking requests are available</div>
						</h3>
						<br />
					</c:otherwise>
				</c:choose>
...
window.location.hash = "myid";
   function getRequestDtls(reqId){
	   document.location.href="./tdmDataMaskingNew?reqId="+reqId+"&edit=false";
   }
