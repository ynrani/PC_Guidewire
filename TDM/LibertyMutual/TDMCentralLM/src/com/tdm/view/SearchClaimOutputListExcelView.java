/*---------------------------------------------------------------------------------------
 * Object Name: SearchClaimOutputListExcelView.Java
 * 
 * Modification Block:
 * --------------------------------------------------------------------------------------
...
{
	private static Logger logger = Logger.getLogger(SearchClaimOutputListExcelView.class);

	@Override
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info(MessageConstant.TDM_EXCEL_SUB + MessageConstant.TDM_EXCEL_CLAIM
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		HSSFSheet excelSheet = workbook.createSheet(MessageConstant.TDM_EXCEL_CLAIM_REC);
		...
		List<TDMClaimSearchResultListDTO> searchClaimOutputList = (List<TDMClaimSearchResultListDTO>) model
				.get(MessageConstant.TDM_CLM_RESULT_DTOS);
	...
	public HSSFColor setColor(HSSFWorkbook workbook, byte r, byte g, byte b) {
		...
		try {
			...
			logger.error(MessageConstant.TDM_EXCEL_CLAIM + MessageConstant.TDM_EXCEL_SET_COLOR
