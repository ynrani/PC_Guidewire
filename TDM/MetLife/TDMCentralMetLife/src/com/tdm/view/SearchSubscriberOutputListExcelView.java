...
{
	private static Logger logger = Logger.getLogger(SearchSubscriberOutputListExcelView.class);

	@Override
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		logger.info(MessageConstant.TDM_EXCEL_SUB + MessageConstant.TDM_EXCEL_BUILD
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		HSSFSheet excelSheet = workbook.createSheet(MessageConstant.TDM_EXCEL_SUB_REC);
	...
	public void setExcelHeader(HSSFSheet excelSheet, HSSFCellStyle style) {
		...
		excelHeader.createCell(9).setCellValue(AppConstant.STATUS);
	...
	public HSSFColor setColor(HSSFWorkbook workbook, byte r, byte g, byte b) {
		logger.info(MessageConstant.TDM_EXCEL_SUB + MessageConstant.TDM_EXCEL_SET_COLOR
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		...
		try {
			...
			logger.error(MessageConstant.TDM_EXCEL_SUB + MessageConstant.TDM_EXCEL_SET_COLOR
	...
	public void setExcelRows(HSSFSheet excelSheet,
		...
		logger.info(MessageConstant.TDM_EXCEL_SUB + MessageConstant.TDM_EXCEL_SET_ROWS
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		int record = 5;
