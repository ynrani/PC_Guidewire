...
public class TdmBaseServiceImpl
{
	...
	@PersistenceUnit(unitName = AppConstant.PERSISTENCE_UNIT_POLO)
	private EntityManagerFactory factoryPolo;
	...
	public EntityManager openPoloEntityManager()
	{
		EntityManager managerPolo = factoryPolo.createEntityManager();

		return managerPolo;
	}

	public void closePoloEntityManager(EntityManager managerPolo)
	{
		managerPolo.close();
	}
