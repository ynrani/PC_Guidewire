...
function confirmation_dialog(title,msg,w,popType,caption1,caption2,data){
	...
	if (popType == 'OkCancel'){
		...
		objContnt.append('<div class="popup_button"><input type="button" value="OK" name="'+data+'" id="smgBtn_ok" onclick="hidePopup(\'popup\',\'popupOverlay\');redirctMRboard(this);"/></div>');
...
function confirmationFotCancel(title,msg,w,popType,caption1,caption2,id){
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button"><input type="button" value="'+yesCaption+'" id="btn_action" name="'+id+'" class="mRght5" onclick="submitPopCancel(this);"/><input type="button" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
/*For Test Data Request*/


function confirmation_dialogTestData(title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button"><input type="button" value="'+yesCaption+'" id="btn_action" class="mRght5" onclick="submitPopTestData();"/><input type="button" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
function confirmation_dialogTestdtReq(title,msg,w,popType,caption1,caption2,data){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	...
	if (popType == 'OkCancel'){
		...
		objContnt.append('<div class="popup_button"><input type="button" value="OK" name="'+data+'" id="smgBtn_ok" onclick="hidePopup(\'popup\',\'popupOverlay\');redirctTestDataReqboard(this);"/></div>');
...
function redirctTestDataReqboard(btn){
	 
		window.location= "./tdmReqTestDataList";
