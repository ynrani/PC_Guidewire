          ...
          <tr>
            ...
            <td class="flied-title" align="left" valign="middle">
            	<form:select path="projName" id="projName" class="down-control">
                  <form:option value="">--Select--</form:option>
                  <form:option value="HEART">HEART</form:option>
                  <form:option value="NWCS">NWCS</form:option>
                  <form:option value="HERO">HERO</form:option>
                  <form:option value="CDM">CDM</form:option>
                  <form:option value="OLEM">OLEM</form:option>
            ...
            <td class="flied-title" align="left" valign="middle">
             	<form:select path="projPhase" id="projPhase" class="down-control">
                  ...
                  <form:option value="UAT">UAT</form:option>
                  <form:option value="Reg">Reg</form:option>
