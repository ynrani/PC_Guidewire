	...
	public String getSearchCriteria(TdmPolicySearchDTO tdmPolicySearchDTO) {
		...
		if (null != tdmPolicySearchDTO) {
			...
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getCompany())) {
				searchCriteria += " + " + messageSource.getMessage("label.policy.comp", null, null)
						+ " : " + tdmPolicySearchDTO.getCompany() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getProductType())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.prodType", null, null) + " : "
						+ tdmPolicySearchDTO.getProductType() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getProductName())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.prodName", null, null) + " : "
						+ tdmPolicySearchDTO.getProductName() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getPolicyNo())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.poilcyNum", null, null) + " : "
						+ tdmPolicySearchDTO.getPolicyNo() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getFaceAmt())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.faceAmt", null, null) + " : "
						+ tdmPolicySearchDTO.getFaceAmt() + "  ";
			}

			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getSsn())) {
				searchCriteria += " + " + messageSource.getMessage("label.policy.ssn", null, null)
						+ " : " + tdmPolicySearchDTO.getSsn() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getInsuFirstName())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.insuFname", null, null) + " : "
						+ tdmPolicySearchDTO.getInsuFirstName() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getInsuLastName())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.insuLname", null, null) + " : "
						+ tdmPolicySearchDTO.getInsuLastName() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getGender())) {
				searchCriteria += " + " + messageSource.getMessage("label.gender", null, null)
						+ " : " + tdmPolicySearchDTO.getGender() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getDob())) {
				searchCriteria += " + " + messageSource.getMessage("label.policy.dob", null, null)
						+ " : " + tdmPolicySearchDTO.getDob() + "  ";
			}
			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getDistChnl())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.distChnl", null, null) + " : "
						+ tdmPolicySearchDTO.getDistChnl() + "  ";
			}

			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getAgntId())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.agentId", null, null) + " : "
						+ tdmPolicySearchDTO.getAgntId() + "  ";
			}

			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getFromDate())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.dateFrom", null, null) + " : "
						+ tdmPolicySearchDTO.getFromDate() + "  ";
			}

			if (StringUtils.isNotEmpty(tdmPolicySearchDTO.getToDate())) {
				searchCriteria += " + "
						+ messageSource.getMessage("label.policy.dateTo", null, null) + " : "
						+ tdmPolicySearchDTO.getToDate() + "  ";
			}
