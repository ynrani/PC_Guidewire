...
<jsp:include page="indexHeader.jsp"></jsp:include>
 <c:if test="${readOnly ne null}">
	 <div style="float: right; width: 11%; border: 0; font-color: #163361 ;padding-top: 15px;padding-left: 74px;">
  ...
  <div class="container">
      ...
      <form:hidden path="status"/>
        ...
        <tbody>
          <tr>
        	<td class="lable-title" width="80%" align="left" valign="middle"><spring:message code="label.pre.q1" /> </td>
         ...
         <tr>
        	<td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q3" /> </td>
          ...
          <tr> 
            <td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q4" /> </td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr>
        	<td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q5" /> </td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr>
            <td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q6" /> </td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr>
        	<td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q7" /> </td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr> 
            <td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q8" /> </td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr>
          	<td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q9" /> </td>
            <td class="flied-title" align="left" valign="middle">
               	 <label class="radio-inline">
          ...
          <tr>
          	<td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q10" /> </td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr>
          	<td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q11" /> </td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr>
          	<td class="lable-title" align="left" valign="middle"><spring:message code="label.pre.q12" /> </td>
            <td class="flied-title" align="left" valign="middle">
               	<label class="radio-inline">
       ...
       <c:when test="${readOnly eq null}">               
        <table  style="width:100%; border:0;font-size: 13px; color: #0C5473;align:center;">
            <tbody> 
                 <tr>
                  <th scope="col">
                    <input type="submit" name="submit" id="back" class="btn-primary btn-cell" value="Back"> 
                    <input type="submit" name="submit" id="savncont" class="btn-primary btn-cell" value="Save and Continue"> 
                 </th>
               </tr>
            </tbody>
         </table> 
        ...
        <table style="width:100%; border:0">
              <tbody>
                <tr>
                  <th scope="col">
                    <input type="submit" name="submit" id="SaveAndContinue" class="btn-primary btn-cell" value="Save and Continue"> 
                 </th>
               </tr>
            </tbody>
         </table> 
         ...
         <c:otherwise>
           <table style="width:100%; border:0;align:center; ">
            <tbody>             
              <tr>
                  <th scope="col">
                    <input type="submit" name="submit" id="back2" class="btn-primary btn-cell" value="Back">
                    <input type="submit" name="submit" id="contin" class="btn-primary btn-cell" value="Continue"> 
                 </th>
               </tr>
            </tbody>
         </table> 
