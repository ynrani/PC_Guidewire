...
public class SearchProviderOutputListExcelView extends AbstractExcelView
{
	...
	private static final Logger logger = LoggerFactory.getLogger(SearchProviderOutputListExcelView.class);

	@Override
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook,
			HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		HSSFSheet excelSheet = workbook.createSheet("Provider Search Reserve Record");
		...
		List<TDMProvSearchResultListDTO> searchProviderOutputList = (List<TDMProvSearchResultListDTO>) model
				.get("tDMProvSearchResultListDTOs");
	...
	public HSSFColor setColor(HSSFWorkbook workbook, byte r, byte g, byte b)
	{
		...
		{
			logger.error(TDMConstants.TDMP_VIEW_ERROR_4, e);
		}
