...
<body>
  <div id="main" class="wrapper mainAll">
    ...
    <jsp:include page="header.jsp"></jsp:include>
  	<div style="float: right; width: 10%; border: 0; font-color: #163361 ;padding-top: 15px;padding-left: 74px;">
      <a class="hrefButton backButtoncls" href="${pageContext.request.servletContext.contextPath}/policyAutoBack"><spring:message code="label.back" /></a>
    </div>
