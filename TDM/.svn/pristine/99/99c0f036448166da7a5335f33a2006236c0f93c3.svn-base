...
public class AccountController
{
			...
			HttpServletRequest request, HttpServletResponse response)
	{
		...
		try
		{
			...
			if (search != null)
			{
				...
				accountDTO = searchManagementService.searchAccoutnDetails(accountDTO);
			}
			else if (reserve != null)
			{
				int recordCount = searchManagementService.reserveBankRecords(accountDTO, userName);
...

	{
		...
		try
		{
			...
			List<TDMBankReservationDTO> resrvationDTOsList = searchManagementService
...

	{
		...
		try
		{
			...
			int unResCount = searchManagementService.unReserveReservedRecords(accountDTO, userName);
