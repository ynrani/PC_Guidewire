...
<body>
						...
						<tbody>
							<tr>
								...
								<td class="flied-title" align="left" valign="middle"><form:select
										...
										<form:option value="NGHO">NGHO</form:option>
										<form:option value="FSPH">FSPH</form:option>
										<form:option value="SPF">SPF</form:option>
										<form:option value="LP">LP</form:option>
										<form:option value="Other">Other</form:option>
									</form:select></td>
							...
							<tr>
								<td class="lable-title" align="left" valign="middle" scope="col">Policy Status</td>
 ...
 %>
						...
						<c:if
							...
							<table style="width:100%; border:0; font-size: 14px; color:#EC0B2D; cellpadding:4;">
				              <tbody>
				                <tr>
				                  <td class="lable-title" align="left" valign="middle">No policies are available meeting the requested criteria.</td>
				                </tr>
				                
				                <tr>
				                  <td class="lable-title" align="left" valign="middle">Modify your search criteria OR Please Click 
				               		<a href="./tdmReqTestData">'Request Test Data'</a>
			                      </td>
				                </tr>
				              </tbody>
				            </table>
