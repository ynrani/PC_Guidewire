<section class="headerDiv">
	<header>
			...
			<div class="primary-nav">
				<nav>
					<ul>
						...
						<li><a href="http://www.hcsc.com/overview.html"
							TARGET="_NEW"><img src="images/about-icon.png" width="20"
								height="20" alt="" /> About Us</a></li>
						<li><a href="http://www.hcsc.com/contact.html"
		...
		<section class="navigation">
			<div class="logo">
				<img src="images/logo-hcsc.jpg" class="logo" alt="" />
			</div>
			<div class="main-nav">
				<nav>
					<ul>
						...
						<li id="tdm_life_cycle"><a id="tdm_life_cycle1"
							href="./index" class="active">TDM Life Cycle</a></li>
		...
		<section class="title-band">
			...
			<div class="advanced-search">
				<a href="./myReservationProv">My Reservations</a>
			</div>
