...
<body>
	<div class="wrapper mainAll">
		...
		<div class="container">
			...
			<form:form id="tdmOnBoardingExportCRForm"
				name="tdmOnBoardingExportCRForm"
				action="${pageContext.request.contextPath}/tdmOnBoardingExportCR">
				<c:choose>
 			...
 			%>
							...
							<table id="search_output_table" class="hoverTable"
								...
								<thead>
									<tr>
										...
										<th align="center" bgcolor="#E3EFFB" scope="col"
											class="whitefont">Application Phase</th>
										<th align="center" bgcolor="#E3EFFB" scope="col"
						...
						<ul class="grdPagination">
							<%
											...
											if (currentPage != 1) {
			   							%>
							<li><a href="tdmOnBoardingDashBoard?page=<%= 1 %>">First</a>
								<div>First</div></li>
							<li><a
								href="tdmOnBoardingDashBoard?page=<%= currentPage-1 %>">&lt;
									Prev</a>
								<div>&lt; Prev</div> <%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
							<li class="disable"><a
								href="tdmOnBoardingDashBoard?page=<%= 1 %>">First</a>
								<div>First</div></li>
							<li class="disable"><a
								href="tdmOnBoardingDashBoard?page=<%= currentPage-1 %>">&lt;
									Prev</a>
							...
							<%
			    						...
			    						%>
							<li><a href="tdmOnBoardingDashBoard?page=<%= i %>"
								id="employeeLink"></a>
								<div><%= i %></div></li>
							<%
			    									}
										...
										%>
							<li><a
								href="tdmOnBoardingDashBoard?page=<%= currentPage+1 %>">Next
									&gt;</a>
								<div>Next &gt;</div></li>
							<li><a href="tdmOnBoardingDashBoard?page=<%= noOfPages %>">Last</a>
								<div>Last</div></li>
							<%
											} else {
											    if(noOfPages > 1) {
							...
							<li class="disable"><a
								...
								<div>Next &gt;</div></li>
							<li class="disable"><a
								href="tdmOnBoardingDashBoard?page=<%= noOfPages %>">Last</a>
								<div>Last</div></li>
							<%
											    }
											}
