<html>
<head>
<title>Logout Page | TestData Application</title>
<meta charset="utf-8">
...
<body>
	<div align="center"
		...
		<h2>Logout Page</h2>
		<div align="center"
			style="text-align: center; padding: 50px; border: 2px solid green; width: 400px;">
			<table style="width: 100%">
				<tr>
					<td><a
						href="${pageContext.request.servletContext.contextPath}/login">Login
							to TestData</a></td>
				</tr>
				<tr></tr>
			</table>
