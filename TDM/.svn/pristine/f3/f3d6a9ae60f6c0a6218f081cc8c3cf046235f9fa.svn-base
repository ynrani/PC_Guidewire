...
function confirmation_dialog(title,msg,w,popType,caption1,caption2,data){
	...
	if (popType == 'OkCancel'){
		...
		objContnt.append('<div class="popup_button buttonsAll8"><input type="button" value="OK" name="'+data+'" id="smgBtn_ok" onclick="hidePopup(\'popup\',\'popupOverlay\');redirctReqList(this);"/></div>');
...
function redirctReqList(btn){
	
		window.location= "./tdmSearchRequestList";
...
function confirmation_dialogYNMR(title,msg,w,popType,caption1,caption2, url){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button buttonsAll8"><input type="button" value="'+yesCaption+'" id="'+url+'"  class="mRght5" onclick="submitPopMr(this.id);"/><input type="button" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
...
function confirmationForCancel(title,msg,w,popType,caption1,caption2,id){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
...
function confirmation_dialogCreReq(title,msg,w,popType,caption1,caption2,form){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button buttonsAll8"><input type="button" value="'+yesCaption+'" id=""  class="mRght5" onclick="return 1"/><input type="button" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
