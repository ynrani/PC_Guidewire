    ...
    <form:form id="dataMaskingForm3" name="dataMaskingForm3" action="${pageContext.request.contextPath}/tdmDataMaskingPage3New" modelAttribute="tdgDataMaskingDTO">
	  ...
	  <c:choose>	  
	     <c:when test="${tdgDataMaskingDTO.dataSubsetting ne null &&  tdgDataMaskingDTO.dataRefresh ne null}">
	      ...
	      <div class="step3-active"><span class="step5-number3">3</span><span class="step-heading">Masking <small>Details</small></span></div>
            ...
            <tbody>
               <tr>
                 <th scope="col" class="buttonsAll15">
                    ...
                    <c:if  test="${tdgDataMaskingDTO.dataSubsetting eq null &&  tdgDataMaskingDTO.dataRefresh eq null}"> 
                    <input type="submit" id="submit" name="submit" class="btn-primary btn-cell" value="Submit"> 
                    </c:if>
                    <c:if  test="${tdgDataMaskingDTO.dataSubsetting ne null || tdgDataMaskingDTO.dataRefresh ne null}"> 
         ...
         <c:otherwise>
           <table style="width:100%; border:0; align:center;">
            <tbody>
              <tr>
                  <th scope="col" class="buttonsAll15">
                    <input type="button"  id="readBack" name="readBack" value="Back"> 
                    <input type="button" name="export" id="export" value="Export to Excel"> 
                 </th>
               </tr>
            </tbody>
         </table>
...
tdgDataMaskingValidationPage3('${tdgDataMaskingDTO.dataSubsetting}', '${tdgDataMaskingDTO.dataRefresh}','${tdgDataMaskingDTO.id}');
