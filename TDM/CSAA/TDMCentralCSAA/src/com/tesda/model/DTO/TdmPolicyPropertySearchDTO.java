...
public class TdmPolicyPropertySearchDTO {
	...
	private List<TdmPolicyPropertySearchResultDTO> fullFdmPolicyPropertySearchResultDTOList;
	...
	public List<TdmPolicyPropertySearchResultDTO> getFullTdmPolicyPropertySearchResultDTOList() {
		return fullFdmPolicyPropertySearchResultDTOList;
	}

	public void setFullTdmPolicyPropertySearchResultDTOList(
			List<TdmPolicyPropertySearchResultDTO> tdmPolicyPropertySearchResultDTOList) {
		this.fullFdmPolicyPropertySearchResultDTOList = tdmPolicyPropertySearchResultDTOList;
	}

	public List<TdmPolicyPropertySearchResultDTO> getFullFdmPolicyPropertySearchResultDTOList() {
		return fullFdmPolicyPropertySearchResultDTOList;
	}

	public void setFullFdmPolicyPropertySearchResultDTOList(
			List<TdmPolicyPropertySearchResultDTO> fullFdmPolicyPropertySearchResultDTOList) {
		this.fullFdmPolicyPropertySearchResultDTOList = fullFdmPolicyPropertySearchResultDTOList;
	}
