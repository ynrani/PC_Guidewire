...
//			excelRow.createCell(12).setCellValue(tdmPolicyPropertySearchResultDTO.getRoofYear());
			 ...
			 * excelRow.createCell(17).setCellValue(tdmPolicyPropertySearchResultDTO.getProvAddr1());
			 * excelRow.createCell(18).setCellValue(tdmPolicyPropertySearchResultDTO.getProvAddr2());
			 * excelRow.createCell(19).setCellValue(tdmPolicyPropertySearchResultDTO.getProvCity());
			 * excelRow.createCell(20).setCellValue(tdmPolicyPropertySearchResultDTO.getProvState());
			 */
