...
public class TdmPolicyPropertySearchController
{
	...
	@Resource(name = "tdmPolicyAutoSearchService")
	TdmPolicyAutoSearchService tdmPolicyAutoSearchService;
	...
	public String policyAutoPost(
		...
		try {
			...
			if (null != search) {
				...
				tdmPolicyPropertySearchDTO = tdmPolicyAutoSearchService.searchPolicyPropRecords(
						tdmPolicyPropertySearchDTO, offSet, recordsperpage, true, userName);
				/*
				 * tdmPolicyPropertySearchDTO =
				 * tdmPolicyAutoSearchService.searchPolicyPropRecordsByPolicySearch(
				 * tdmPolicyPropertySearchDTO, offSet, recordsperpage, true, userName);
				 */
