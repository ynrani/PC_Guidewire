...
public class SearchPolicyAutoListExcelView extends AbstractExcelView
{
	...
	public void setExcelHeader(HSSFSheet excelSheet, HSSFCellStyle style) {
		...
		/*
		 * 
		 * excelHeader.getCell(14).setCellStyle(style); excelHeader.getCell(15).setCellStyle(style);
		 * excelHeader.getCell(16).setCellStyle(style); excelHeader.getCell(17).setCellStyle(style);
		 * excelHeader.getCell(18).setCellStyle(style); excelHeader.getCell(19).setCellStyle(style);
		...
		/*
		 * 
		 * excelSheet.autoSizeColumn(14); excelSheet.autoSizeColumn(15);
		 * excelSheet.autoSizeColumn(16); excelSheet.autoSizeColumn(17);
		 * excelSheet.autoSizeColumn(18); excelSheet.autoSizeColumn(20);
		 */
	...
	public void setExcelRows(HSSFSheet excelSheet,
		...
		for (TdmPolicyAutoSearchResultDTO tdmPolicyAutoSearchResultDTO : searchPolicyAutoOutputList) {
			...
			/*
			 * 
			 * excelRow.getCell(14).setCellStyle(style); excelRow.getCell(15).setCellStyle(style);
			 * excelRow.getCell(16).setCellStyle(style); excelRow.getCell(17).setCellStyle(style);
			 * excelRow.getCell(18).setCellStyle(style); excelRow.getCell(19).setCellStyle(style);
			 ...
			 * excelSheet.autoSizeColumn(14); excelSheet.autoSizeColumn(15);
			 * excelSheet.autoSizeColumn(16); excelSheet.autoSizeColumn(17);
			 * excelSheet.autoSizeColumn(18); excelSheet.autoSizeColumn(19);
