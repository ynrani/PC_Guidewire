	...
	<header>
					...
					<ul>
						...
						<li id="services"><a href="#" >Services</a>
							...
							%>
								...
								<li id="services_sub"><a href="./tdmDataSubsetting">Data Sub Setting</a></li>
								<li id="services_mask"><a href="./tdmDataMaskingNew">Data Masking</a></li>
								<li id="services_ref"><a href="./tdmDataRefresh">Data Refresh</a></li>
						...
						<li id=""><a href="#" >Quick Link</a>
							...
							%>
								...
								<li id=""><a href="./tdmDataSubsetting">Data Sub Setting</a></li>
		...
		<section class="title-band">
			...
			<%
				if(!(request.getSession().getAttribute(AppConstant.ROLE).equals(AppConstant.ROLE_USER))){
			%>
			<div class="advanced-search"><a href="./myReservationProv">My Reservations</a></div>
			<% } %> 
		</section>
	</header>
</section>