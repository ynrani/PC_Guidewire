...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <title> TDM Central | Non Standard Search</title>
   ...
   <jsp:include page="header.jsp"></jsp:include>
    <script src="include/menu.js"></script>
      <div id="tabs-1" class="container"> 
          ...
          <form:form id="testDataFormNon" name="testDataFormNon" action="${pageContext.request.contextPath}/testdaNonStand" modelAttribute="tdmNonStandSearchDTO">
          <div class="">
            ...
            <table style="width:100%; border:0; font-size: 13px;" >
              <tbody>
                ...
                <tr>
                  ...
                  <td class="lable-title" align="left" valign="middle" scope="col"><spring:message code="label.subc.type"/><span>*</span></td>
                  <td class="flied-title" align="left" valign="middle" scope="col">

                   <form:select path="subscType" id="subscType" class="down-control">
                  	 	<form:option value="">--Select--</form:option>
                   	    <c:forEach items="${tdmNonStandSearchDTO.tdmSubscTypeMastDTOs}" var="tdmSubscTypeMastDTOs">
                 ...
                 <tr>
                  <td class="lable-title" align="left" valign="middle">
                    <spring:message code="label.prov.type" /><span>*</span>
                  </td>
                  <td class="flied-title" align="left" valign="middle">
                    <form:select path="provType" id="provType" class="down-control">
                    	<form:option value="">--Select--</form:option>
                   	    <c:forEach items="${tdmNonStandSearchDTO.tdmProviderTypeParentDTOs}" var="tdmProviderTypeParentDTOs">
                    ...
                    <td class="flied-title" align="left" valign="middle" scope="col">
                      ...
                      <form:option value="">All</form:option>
                       <c:forEach items="${tdmNonStandSearchDTO.tdmProviderCatParentDTOs}" var="tdmProviderCatParentDTOs">
                ...
                <tr>
                  ...
                  <td class="flied-title" align="left" valign="middle">
                    <form:select path="provSpecType" id="provSpecType" multiple="true"  class="down-control">
                      <form:option value="">All</form:option>
                       <c:forEach items="${tdmNonStandSearchDTO.specDropdown}" var="specDropdown">
                 ...
                 <td class="lable-title" align="left" valign="middle">
                  ...
                  <td class="flied-title" align="left" valign="middle">
                    <form:select path="provState" id="provState" multiple="true"  class="down-control">
                      <form:option value="">All</form:option>
                      <c:forEach items="${tdmNonStandSearchDTO.tdmUsStateDTOs}" var="tdmUsStateDTOs">
                ...
                <tr>
                 ...
                 <td class="lable-title" align="left" valign="middle"><spring:message code="label.subc.status"/></td>
                  <td class="flied-title" align="left" valign="middle">
                  	<form:select path="subscStatus" id="subscStatus"  class="down-control">
                 		<form:option value="">All</form:option>
                    	<c:forEach items="${tdmNonStandSearchDTO.tdmSubscStatusMastDTOs}" var="tdmSubscStatusMastDTOs">
         	 ...
         	 <tr> 
                ...
                <td class="flied-title" align="left" valign="middle">
                  <form:select path="claimStatus" id="claimStatus" class="down-control">
                 	<form:option value="">All</form:option>
                    <c:forEach items="${tdmNonStandSearchDTO.tdmClaimStatusMastDTOs}" var="tdmClaimStatusMastDTOs">
              ...
              <tbody id="myContent">
                ...
                <tr>
                  ...
                  <td class="flied-title" align="left" valign="middle">
                    <form:input path="termDate" id="termDate" class="date-control datepicker" readonly="ture"/>
                  </td>
                </tr>
              ...
              <tbody>
                <tr>
                  <td colspan="4" align="center" valign="middle" class="buttonsAll8">
                    ...
                    <input type="reset" value="Reset" onClick="clearFields('./testdaNonStand');">
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <br/>
            ...
            <c:if test="${tdmNonStandSearchDTO.tdmNonStandardResultListDTOs eq null}">
            
            <c:if test="${result ne null}">
            <table style="width:100%; border:0; font-size: 12px; font-style: italic; color:#7C6DC2" >
              <tbody>
                <tr>
             ...
             <br/>
	          <br/>
	            <table style="width:100%; border:0; font-size: 12px; color:#EC0B2D" >
	              <tbody>
	                <tr>
	                  <td class="lable-title" align="left" valign="middle">No Records Found</td>
          ...
          <c:if test="${tdmNonStandSearchDTO.tdmNonStandardResultListDTOs ne null &&  not empty tdmNonStandSearchDTO.tdmNonStandardResultListDTOs}">
								<%
            ...
            <div class="scrollingX" id="myid"  >
              <table id="search_output_table" class="table tablesorter"  style="width:100%;font-size: 13px;">
                <thead>
                  <tr>
                    <th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message code="lebel.chkb"/></th>
                     <th bgcolor="#E3EFFB" height="25" class="whitefont"><spring:message code="label.subc.subcId"/></th>
                ...
                <tbody>
                  <c:forEach items="${tdmNonStandSearchDTO.tdmNonStandardResultListDTOs}" var="tdmNonStandardResultListDTOs" varStatus="status">
                    <tr>
                      <c:if test="${tdmNonStandardResultListDTOs.reservedYN eq null }">
                        <td>
                          <label class="checkbox-inline">
                            <form:checkbox path="tdmNonStandardResultListDTOs[${status.index}].reservedYN" id="tdmNonStandardResultListDTOs[${status.index}].reservedYN" class="cb_class checkBoxCls" value="Yes" />
                          </label>
                        </td>
                      </c:if>
                  ...
                  <c:forEach items="${tdmNonStandSearchDTO.tdmNonStandardResultListDTOs}" var="tdmNonStandardResultListDTOs" varStatus="status">
                    ...
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].subscriberId" />
                   
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].firstName" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].lastName" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].subcType" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].subscriberNames" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].subcState" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].subcZip" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].ssn" />
                    
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].providerId" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].provType" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].specialityDescription" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].provCatgType" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].provState" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].tin" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].npi" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].provContactType" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].terminationDate" />
                    
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].claimId" />
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].claimStatus" />
    							...
    							<ul class="grdPagination">
			                  			<%
											...
											if (currentPage != 1) {
			   							%>
			   									<li><a href="testdaNonStand?page=<%= 1 %>" onClick="showLoading();">&lt;&lt;</a><div>&lt;&lt;</div></li>
			   									<li><a href="testdaNonStand?page=<%= currentPage-1 %>" onClick="showLoading();">&lt;</a><div>&lt;</div>
			   							<%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
			   								 	<li class="disable"><a href="testdaNonStand?page=<%= 1 %>" onClick="showLoading();">&lt;&lt;</a><div>&lt;&lt;</div></li>
			   									<li class="disable"><a href="testdaNonStand?page=<%= currentPage-1 %>" onClick="showLoading();">&lt;</a><div>&lt;</div>
			   							<%
			   								 	}
			   								}
											if(noOfPages > 1) {
			    						...
			    						%>
			    										<li><a href="testdaNonStand?page=<%= i %>" id="employeeLink"  onClick="showLoading();"><%= i %></a><div><%= i %></div></li>
			    						<%
			    									}
			    								}
			    							}
										...
										%>
			    		     					<li><a href="testdaNonStand?page=<%= currentPage+1 %>" onClick="showLoading();">&gt;</a><div>&gt;</div></li>
			    		     					<li><a href="testdaNonStand?page=<%= noOfPages %>" onClick="showLoading();">&gt;&gt;</a><div>&gt;&gt;</div></li>
			    		   				<%
											} else {
											    if(noOfPages > 1) {
										%>
			    		     					<li class="disable"><a href="testdaNonStand?page=<%= currentPage+1 %>" onClick="showLoading();">&gt;</a><div>&gt;</div></li>
			    		     					<li class="disable"><a href="testdaNonStand?page=<%= noOfPages %>" onClick="showLoading();">&gt;&gt;</a><div>&gt;&gt;</div></li>
										<%
											    }
											}
										%>
