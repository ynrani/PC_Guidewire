            ...
            <td class="lable-title" align="left" valign="middle"><spring:message code="label.env" /><span>*</span> </td>
          	<td class="flied-title" align="left" valign="middle">
               <form:select path="envType" id="envType" class="down-control">
                  ...
                  <form:option value="App1Env1">App1_Env_1</form:option>
                  <form:option value="App1Env2">App1_Env_2</form:option>
                  <form:option value="App2Env1">App2_Env_1</form:option>
                  <form:option value="App2Env2">App2_Env_2</form:option>
                  <form:option value="App3Env1">App3_Env_1</form:option>
                  <form:option value="App3Env2">App3_Env_2</form:option>
                  <form:option value="App4Env1">App4_Env_1</form:option>
                  <form:option value="App4Env2">App4_Env_2</form:option>
               </form:select>
             </td>
           
           <td class="lable-title" align="left" valign="middle">Application Phase</td>
            <td class="flied-title" align="left" valign="middle">
             	<form:select path="appPhase" id="appPhase" class="down-control">
                  <form:option value="">--Select--</form:option>
                   <form:option value="App1Phase1">App1_Phase_1</form:option>
                  <form:option value="App1Phase2">App1_Phase_2</form:option>
                  <form:option value="App2Phase1">App2_Phase_1</form:option>
                  <form:option value="App2Phase2">App2_Phase_2</form:option>
                  <form:option value="App3Phase1">App3_Phase_1</form:option>
                  <form:option value="App3Phase2">App3_Phase_2</form:option>
                  <form:option value="App4Phase1">App4_Phase_1</form:option>
                  <form:option value="App4Phase2">App4_Phase_2</form:option>
               </form:select>
            </td> 
