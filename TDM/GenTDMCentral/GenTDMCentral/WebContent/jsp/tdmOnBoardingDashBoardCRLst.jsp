	   ...
	   <table id="search_output_table" class="hoverTable" style="width:100%; font-size: 13px; border:0; cellpadding:0; cellspacing:1;">
		 ...
		 <ul class="grdPagination">
			                  			<%
											...
											if (currentPage != 1) {
			   							%>
			   									<li><a href="tdmOnBoardingDashBoardCRLst?page=<%= 1 %>">First</a><div>First</div></li>
			   									<li><a href="tdmOnBoardingDashBoardCRLst?page=<%= currentPage-1 %>">&lt; Prev</a><div>&lt; Prev</div>
			   							<%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
			   								 	<li class="disable"><a href="tdmOnBoardingDashBoardCRLst?page=<%= 1 %>">First</a><div>First</div></li>
			   									<li class="disable"><a href="tdmOnBoardingDashBoardCRLst?page=<%= currentPage-1 %>">&lt; Prev</a><div>&lt; Prev</div>
			   							<%
			   								 	}
			   								}
											if(noOfPages > 1) {
			    						...
			    						%>
			    										<li><a href="tdmOnBoardingDashBoardCRLst?page=<%= i %>" id="employeeLink"><%= i %></a><div><%= i %></div></li>
			    						<%
			    									}
			    								}
			    							}
										...
										%>
			    		     					<li><a href="tdmOnBoardingDashBoardCRLst?page=<%= currentPage+1 %>">Next &gt;</a><div>Next &gt;</div></li>
			    		     					<li><a href="tdmOnBoardingDashBoardCRLst?page=<%= noOfPages %>">Last</a><div>Last</div></li>
			    		   				<%
											} else {
											    if(noOfPages > 1) {
										%>
			    		     					<li class="disable"><a href="tdmOnBoardingDashBoardCRLst?page=<%= currentPage+1 %>">Next &gt;</a><div>Next &gt;</div></li>
			    		     					<li class="disable"><a href="tdmOnBoardingDashBoardCRLst?page=<%= noOfPages %>">Last</a><div>Last</div></li>
										<%
											    }
											}
										%>
