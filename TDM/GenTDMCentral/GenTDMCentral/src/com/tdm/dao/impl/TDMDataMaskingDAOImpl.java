...
public class TDMDataMaskingDAOImpl implements TDMDataMaskingDAO
{
	...
	public TdmUserDO getUserDetails(EntityManager managerUser, String userId) throws DAOException {
		...
		try {
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_USER_DTL
	...
	@Override
	public RequestorDO getSaveReqDtls(RequestorDO requestorDO, EntityManager managerDtmask) throws DAOException {
	...
	public String maskingRecId(EntityManager managerDtmask) throws DAOException {
		...
		try {
			String seqNo = (String) managerDtmask.createNativeQuery(
					"SELECT LPAD ( SEQ_MASK_REQ_ID.NEXTVAL, 6, '0' ) ID FROM DUAL").getSingleResult();
			logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_MSK_REC_ID
					+ MessageConstant.LOG_INFO_RETURN);
			return seqNo;
		} catch (IllegalStateException illegalStateEx) {
	...
	public RequestorDO getSavedDtls(String reqId, EntityManager managerDtmask) throws DAOException {
		...
		try {
			if (0 < (long) managerDtmask.createQuery("SELECT COUNT(*) FROM RequestorDO r WHERE r.id ='" + reqId + "'")
					.getSingleResult()) {
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_SAVED_DTLS
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_SAVED_DTLS
	...
	@Override
	public Long getDataMaskingRecordsCount(String userId, String type, String status, EntityManager managerDtmask)
			throws DAOException {
		logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_REC_COUNT
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		String query = null;
		try {
			if (null != status && "U".equalsIgnoreCase(status)) {
				if (type.equalsIgnoreCase(AppConstant.FR)) {
					query = "SELECT COUNT(*) FROM RequestorDO p where p.userName='" + userId + "' AND p.vno = 0";
				} else if (type.equalsIgnoreCase(AppConstant.CR)) {
					query = "SELECT COUNT(*) FROM RequestorDO p where p.userName='" + userId + "' AND p.vno != 0";
				}
			} else if (null != status && "A".equalsIgnoreCase(status)) {
				if (type.equalsIgnoreCase(AppConstant.FR)) {
					query = "SELECT COUNT(*) FROM RequestorDO p where p.vno = 0";
				} else if (type.equalsIgnoreCase(AppConstant.CR)) {
					query = "SELECT COUNT(*) FROM RequestorDO p where p.vno != 0";
				}
			} else if (null != status && (!"A".equalsIgnoreCase(status) || "U".equalsIgnoreCase(status))) {
				if (type.equalsIgnoreCase(AppConstant.FR)) {
					query = "SELECT COUNT(*) FROM RequestorDO p where p.status='" + status + "' AND p.vno = 0";
				} else if (type.equalsIgnoreCase(AppConstant.CR)) {
					query = "SELECT COUNT(*) FROM RequestorDO p where p.status='" + status + "' AND p.vno != 0";
				}
			}
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_REC_COUNT
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_REC_COUNT
	...
	@Override
	public List<RequestorDO> searchDataMaskingRecords(int offSet, int recordsperpage, boolean pageNationOnOffFlag,
			String userId, String type, String status, EntityManager managerDtmask) throws DAOException {
		logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_SEARCH_DT_MSK_RECS
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		String query = null;
		try {
			...
			if (null != status && "U".equalsIgnoreCase(status)) {
				...
				if (type.equalsIgnoreCase(AppConstant.FR)) {
					query = "SELECT r FROM RequestorDO r where r.status='" + status
							+ "' AND r.vno=0 Order By r.id desc";
				} else if (type.equalsIgnoreCase(AppConstant.CR)) {
					query = "SELECT r FROM RequestorDO r where r.status='" + status
							+ "' AND r.vno != 0 Order By r.id desc";
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_SEARCH_DT_MSK_RECS
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_SEARCH_DT_MSK_RECS
	...
	@Override
	public List<RequestorDO> getSavedDtlsforExport(String userId, String type, EntityManager managerDtmask)
			throws DAOException {
		...
		try {
			if (type.equalsIgnoreCase(AppConstant.FR)) {
				query = "SELECT p FROM RequestorDO p where p.userName='" + userId + "' AND p.vno = 0";
			} else if (type.equalsIgnoreCase(AppConstant.CR)) {
				query = "SELECT p FROM RequestorDO p where p.userName='" + userId + "' AND p.vno != 0";
			}
			@SuppressWarnings(AppConstant.UNCHECKED)
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_SAVED_EXPT
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_SAVED_EXPT
	...
	@SuppressWarnings(AppConstant.UNCHECKED)
	@Override
	public List<String> getReqIdList(String userId, EntityManager managerDtmask, String reqIdtoken) throws DAOException {
		...
		try {
			if (reqIdtoken.toUpperCase().contains(AppConstant.TR)) {
				reqIds = managerDtmask.createQuery(
						"SELECT p.onboardReqId FROM TdmOnboardReqDO p where p.onboardReqId like'%" + reqIdtoken
								+ "%' AND P.actionBy='" + userId + "'").getResultList();
			} else if (reqIdtoken.toUpperCase().contains(AppConstant.MR)) {
				reqIds = managerDtmask.createQuery(
						"SELECT p.id FROM RequestorDO p where p.id like'%" + reqIdtoken + "%' AND p.userName='"
								+ userId + "'").getResultList();
			}
		} catch (IllegalStateException illegalStateEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_REC_ID_LIST
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_REC_ID_LIST
	...
	@Override
	public TdmOnboardReqDO getEditableDetails(EntityManager managerDtmask, String reqId) throws DAOException {
		...
		try {
			TdmOnboardReqDO tdmOnboardReqDO = (TdmOnboardReqDO) managerDtmask.createQuery(
					"SELECT p FROM TdmOnboardReqDO p where p.onboardReqId ='" + reqId + "'").getSingleResult();
			logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_EDIT_DTLS
					+ MessageConstant.LOG_INFO_RETURN);
			return tdmOnboardReqDO;
		} catch (IllegalStateException illegalStateEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_EDIT_DTLS
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_EDIT_DTLS
	...
	public TdmOnBoardReqDTO getUserDetailsOnboard(String userId, EntityManager managerUser,
		...
		logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_USER_DTL_ONBOARD
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		try {
			TdmUserDO userDO = (TdmUserDO) managerUser.createQuery(
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_USER_DTL_ONBOARD
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_USER_DTL_ONBOARD
	...
	public String onBoardingRecId(EntityManager managerDtmask) throws DAOException {
		logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_ONBOARD_REC_ID
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		try {
			String seqNO = (String) managerDtmask.createNativeQuery(
					"SELECT LPAD ( SEQ_ONBOARD_REQ_ID.NEXTVAL, 6, '0' ) ID FROM DUAL").getSingleResult();
			logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_ONBOARD_REC_ID
					+ MessageConstant.LOG_INFO_RETURN);
			return seqNO;
		} catch (IllegalStateException illegalStateEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_ONBOARD_REC_ID
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_ONBOARD_REC_ID
	...
	@Override
	public TdmOnboardReqDO getSaveOnboardingReq(EntityManager managerDtmask, TdmOnboardReqDO tdmOnboardReqDO)
			throws DAOException {
		logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_SAVE_ONBOARD_REQ
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		try {
			managerDtmask.getTransaction().begin();
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_SAVE_ONBOARD_REQ
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_GET_SAVE_ONBOARD_REQ
	...
	@Override
	public Long getOnBoardingRecordsCount(String userId, String type, String status, EntityManager managerDtmask)
			throws DAOException {
		...
		try {
			...
			if (null != status && "U".equalsIgnoreCase(status)) {
				if (type.equalsIgnoreCase(AppConstant.FR)) {
					query = "SELECT COUNT(*) FROM TdmOnboardReqDO p where p.actionBy='" + userId + "' AND p.vno = 0";
				} else if (type.equalsIgnoreCase(AppConstant.CR)) {
					query = "SELECT COUNT(*) FROM TdmOnboardReqDO p where p.actionBy='" + userId + "' AND p.vno != 0";
				}
			} else if (null != status && "A".equalsIgnoreCase(status)) {
				...
				if (type.equalsIgnoreCase(AppConstant.FR)) {
					query = "SELECT COUNT(*) FROM TdmOnboardReqDO p where p.status='" + status + "' AND p.vno = 0";
				} else if (type.equalsIgnoreCase(AppConstant.CR)) {
					query = "SELECT COUNT(*) FROM TdmOnboardReqDO p where p.status='" + status + "' AND p.vno != 0";
				}
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_SAVE_USER_DTLS
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_SAVE_USER_DTLS
	...
	@Override
	public List<TdmOnboardReqDO> searchOnBoardingRecords(int offSet, int recordsperpage, boolean pageNationOnOffFlag,
			String userId, String type, String status, EntityManager managerDtmask) throws DAOException {
		logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_SEARCH_ONBOARD_RECS
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		String query = null;
		try {
			...
			if (null != status && "U".equalsIgnoreCase(status)) {
				...
				if (type.equalsIgnoreCase(AppConstant.FR)) {
					query = "SELECT p FROM TdmOnboardReqDO p where p.status='" + status
							+ "' AND p.vno = 0 Order By p.onboardReqId desc";
				} else if (type.equalsIgnoreCase(AppConstant.CR)) {
					query = "SELECT p FROM TdmOnboardReqDO p where p.status='" + status
							+ "'  AND p.vno != 0 Order By p.onboardReqId desc";
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_SEARCH_ONBOARD_RECS
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_SEARCH_ONBOARD_RECS
	...
	@Override
	public boolean getCheckExistingReqYesNo(String userId, EntityManager managerDtmask) throws DAOException {
		...
		try {
			if (0 < (long) managerDtmask.createQuery(
					"SELECT COUNT(*) FROM RequestorDO r WHERE r.status='" + AppConstant.OPEN + "' AND r.name ='"
							+ userId + "' AND r.id NOT LIKE '%CR%'").getSingleResult()) {
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_CHECK_EXISTING
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_CHECK_EXISTING
	...
	public boolean dtMaskCancelReq(String reqId, EntityManager managerDtmask) throws DAOException {
		...
		try {
			...
			int updateCount = managerDtmask.createQuery(
					"UPDATE RequestorDO r SET r.status='" + AppConstant.CANCEL + "' WHERE r.id ='" + reqId + "'")
					.executeUpdate();
			managerDtmask.getTransaction().commit();
			checkExistingReq = true;
			logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_DT_MSK_DAO_CANCEL_REQ
	...
	@Override
	public boolean cancelOnBoardingReq(EntityManager managerDtmask, String reqId) throws DAOException {
		logger.info(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_ONBOARDING_SERVICE_CANCEL_REQ
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		try {
			if (!reqId.contains(AppConstant.CR)) {
				if (1 < (Long) managerDtmask.createQuery(
						"SELECT COUNT(*) FROM TdmOnboardReqDO p where p.onboardReqId like '%" + reqId
			...
			TdmOnboardReqDO reqDo = (TdmOnboardReqDO) managerDtmask.createQuery(
					"SELECT p FROM TdmOnboardReqDO p where p.onboardReqId = '" + reqId + "' AND p.status='Submitted'")
					.getSingleResult();
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_ONBOARDING_SERVICE_CANCEL_REQ
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_ONBOARDING_SERVICE_CANCEL_REQ
	...
	public boolean cancelMaskingReq(EntityManager managerDtmask, String reqId) throws DAOException {
		...
		try {
			...
			RequestorDO reqDo = (RequestorDO) managerDtmask.createQuery(
					"SELECT p FROM RequestorDO p where p.id = '" + reqId + "' AND p.status='Submitted'")
					.getSingleResult();
			reqDo.setStatus(AppConstant.STATUS_CANCELLED);
			managerDtmask.getTransaction().begin();
			reqDo = managerDtmask.merge(reqDo);
			...
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_MASKINGSERVICE_CANCEL_REQ
					+ MessageConstant.LOG_ERROR_EXCEPTION);
			throw new DAOException(MessageConstant.NRE_ENTITY_MGR_FACTORY_CLOSED_EXCEPTION, illegalStateEx);
		} catch (IllegalArgumentException illegalArgEx) {
			logger.error(MessageConstant.TDM_DT_MSK_DAO + MessageConstant.TDM_MASKINGSERVICE_CANCEL_REQ
		...
		try {
			...
			if (null != managerDtmask) {
				if (null != tdgDataMaskingDTO) {
					...
					if (tdgDataMaskingDTO.getType().equalsIgnoreCase("MR")
							|| tdgDataMaskingDTO.getType().equalsIgnoreCase("MRCR")) {
						requestorDO = managerDtmask.find(RequestorDO.class, tdgDataMaskingDTO.getId());

						requestorDO.setStatus(sts);
						if (null != tdgDataMaskingDTO.getAssignTo()) {
							requestorDO.setAssignTo(tdgDataMaskingDTO.getAssignTo());
						}
						if (null != tdgDataMaskingDTO.getReason()) {
							requestorDO.setReason(tdgDataMaskingDTO.getReason());
						}

						managerDtmask.getTransaction().begin();
						managerDtmask.merge(requestorDO);
						managerDtmask.getTransaction().commit();

					} else if (tdgDataMaskingDTO.getType().equalsIgnoreCase("OR")
							|| tdgDataMaskingDTO.getType().equalsIgnoreCase("ORCR")) {
						tdmOnboardReqDO = managerDtmask.find(TdmOnboardReqDO.class, tdgDataMaskingDTO.getId());

						tdmOnboardReqDO.setStatus(sts);

						if (null != tdgDataMaskingDTO.getAssignTo()) {
							tdmOnboardReqDO.setAssignTo(tdgDataMaskingDTO.getAssignTo());
						}
						if (null != tdgDataMaskingDTO.getReason()) {
							tdmOnboardReqDO.setReason(tdgDataMaskingDTO.getReason());
						}
