...
public interface TDMDataMaskingService
{
	...
	public TdmOnBoardReqDTO getUserDetails(String attribute, TdmOnBoardReqDTO tdmOnboardReqDTO) throws ServiceException;

	public TdmOnBoardReqDTO getSaveOnboardingReq(TdmOnBoardReqDTO tdmOnboardReqDTO) throws ServiceException;

	public Long getReservedRecordsCountOnBoard(String attribute, String type, String status) throws ServiceException;

	public List<TdgDataMaskingDTO> getAllOnBoardRequestedRecordForPagination(int offSet, int recordsperpage, boolean b,
			String attribute, String type, String status) throws ServiceException;
	...
	public String updateRequestStatus(TdgDataMaskingDTO tdgDataMaskingDTO, String userId, String sts)
			throws ServiceException;
}
