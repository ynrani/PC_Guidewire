              ...
              <tbody>
                <tr>
                  <td colspan="4" align="center" valign="middle">
                    ...
                    <input type="reset" value="Reset" class="btn-primary btn-cell" onClick="clearFields('./testdaNonStand');">
                  </td>
                </tr>
              </tbody>
            </table>
                    ...
                    <form:hidden path="tdmNonStandardResultListDTOs[${status.index}].claimStatus" />
    							...
    							<ul class="grdPagination">
			                  			<%
											...
											if (currentPage != 1) {
			   							%>
			   									<li><a href="testdaNonStand?page=<%= 1 %>">&lt;&lt;</a><div>&lt;&lt;</div></li>
			   									<li><a href="testdaNonStand?page=<%= currentPage-1 %>">&lt;</a><div>&lt;</div>
			   							<%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
			   								 	<li class="disable"><a href="testdaNonStand?page=<%= 1 %>">&lt;&lt;</a><div>&lt;&lt;</div></li>
			   									<li class="disable"><a href="testdaNonStand?page=<%= currentPage-1 %>">&lt;</a><div>&lt;</div>
			   							<%
			   								 	}
			   								}
											if(noOfPages > 1) {
			    						...
			    						%>
			    										<li><a href="testdaNonStand?page=<%= i %>" id="employeeLink"><%= i %></a><div><%= i %></div></li>
			    						<%
			    									}
			    								}
			    							}
										...
										%>
			    		     					<li><a href="testdaNonStand?page=<%= currentPage+1 %>">&gt;</a><div>&gt;</div></li>
			    		     					<li><a href="testdaNonStand?page=<%= noOfPages %>">&gt;&gt;</a><div>&gt;&gt;</div></li>
			    		   				<%
											} else {
											    if(noOfPages > 1) {
										%>
			    		     					<li class="disable"><a href="testdaNonStand?page=<%= currentPage+1 %>">&gt;</a><div>&gt;</div></li>
			    		     					<li class="disable"><a href="testdaNonStand?page=<%= noOfPages %>">&gt;&gt;</a><div>&gt;&gt;</div></li>
										<%
											    }
											}
										%>
